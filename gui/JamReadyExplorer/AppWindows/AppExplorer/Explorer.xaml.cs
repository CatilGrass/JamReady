...
public sealed partial class Explorer : INotifyPropertyChanged
{
    ...
    private readonly double _explorerItemSizeMin = 15;
    private readonly double _explorerItemSizeMax = 75;
    private readonly double _explorerItemFontSizeMin = 11;
    private readonly double _explorerItemFontSizeMax = 16;
    private VirtualizingStackPanel? _explorerWrapPanel;
    ...
    private void Explorer_Close(object sender, RoutedEventArgs e)
    {
        ...
        if (preference != null)
        {
            ...
            // 存储窗口位置
            preference.WindowPosition.Left = Left;
            preference.WindowPosition.Top = Top;
            preference.WindowPosition.Width = Width;
            preference.WindowPosition.Height = Height;
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void ExplorerItemPanel_OnSizeChanged(object sender, SizeChangedEventArgs e)
    {
        if (e.Source is VirtualizingStackPanel panel)
        {
